...
COPY public.foto (id, contenido, titulo, activa, precio) FROM stdin;
15	15.jpg	Pulsera roja	t	50
16	16.jpg	marron	t	50
17	17.JPG	Verde con anillo	t	75
18	18.JPG	Dos colores	t	50
\.
...
SELECT pg_catalog.setval('public.foto_id_seq', 18, true);
...
SELECT pg_catalog.setval('public.orden_detalle_id_seq', 50, true);
...
SELECT pg_catalog.setval('public.orden_id_seq', 45, true);
